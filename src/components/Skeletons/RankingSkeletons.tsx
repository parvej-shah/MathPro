  ...
  <div className="mb-12">
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
      ...
      <div className="order-2 md:order-1 md:mt-16">
        <SkeletonPulse>
          <div className="relative bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-xl border-2 border-gray-700/50 rounded-3xl p-8 shadow-2xl">
            <div className="absolute -top-4 -right-4 bg-gray-700 w-12 h-12 rounded-full"></div>
            <div className="flex flex-col items-center">
              <div className="w-32 h-32 rounded-full bg-gray-700 mb-6"></div>
              <div className="h-6 bg-gray-700 rounded-lg w-32 mb-2"></div>
      ...
      <div className="order-1 md:order-2">
        <SkeletonPulse>
          <div className="relative bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-xl border-2 border-gray-700/50 rounded-3xl p-8 shadow-2xl">
            <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 w-16 h-16 bg-gray-700 rounded-full"></div>
            <div className="absolute -top-4 -right-4 bg-gray-700 w-16 h-16 rounded-full"></div>
            <div className="flex flex-col items-center pt-6">
              <div className="w-36 h-36 rounded-full bg-gray-700 mb-6"></div>
              <div className="h-8 bg-gray-700 rounded-lg w-40 mb-2"></div>
              <div className="h-4 bg-gray-700 rounded w-24 mb-4"></div>
              <div className="h-12 bg-gray-700 rounded w-20 mb-1"></div>
              <div className="h-4 bg-gray-700 rounded w-12"></div>
            </div>
          </div>
        </SkeletonPulse>
...
export const MyRankSkeleton: React.FC = () => (
  <div className="max-w-5xl mx-auto mb-8">
    <SkeletonPulse>
      <div className="bg-gradient-to-r from-gray-800/40 to-gray-900/40 backdrop-blur-lg border border-gray-700/50 rounded-2xl p-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <div className="bg-gray-700 p-3 rounded-full w-14 h-14"></div>
...
export const TableSkeleton: React.FC = () => (
  <div className="max-w-5xl mx-auto">
    <div className="bg-gray-800/40 backdrop-blur-lg border border-gray-700/50 rounded-2xl overflow-hidden">
      {/* Header skeleton */}
      <SkeletonPulse>
        <div className="bg-gradient-to-r from-gray-800/60 to-gray-900/60 backdrop-blur-lg border-b border-gray-700/50 px-6 py-4">
...
export const CourseSelectorSkeleton: React.FC = () => (
  <div className="mb-8 max-w-2xl mx-auto">
    <SkeletonPulse>
      <div className="bg-gray-800/60 backdrop-blur-lg border border-gray-700/50 rounded-xl px-6 py-4">
