                    ...
                    >
                        ...
                        <div className="flex-1">
                            <div className="flex items-center gap-3 flex-wrap">
                                <p className={`text-2xl ${!chapter.is_free && 'text-[#565656]'}`}>
                                    {chapter.title}
                                </p>
                                {!chapter.is_free && chapter.modules.some(m => (m?.data?.category === 'VIDEO' || m?.data?.category === 'PDF') && (m?.data?.is_free === true || (m as any)?.is_free === true)) && (
                                    <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-gradient-to-r from-purple/10 to-purple/5 border border-purple/30 rounded-full text-xs font-semibold text-purple">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        >
                                            <path
                                                ...
                                                fill={chapter.is_free ? '#B153E0' : '#565656'}
                                            />
                                        </svg>
                                        <p className={!chapter.is_free ? 'text-[#565656]' : ''}>
            ...
            >
                ...
                {chapter.modules && chapter.modules.length > 0 ? (
                    ...
                    <div className="text-center py-8">
                        <p className="text-paragraph dark:text-darkParagraph text-lg">
